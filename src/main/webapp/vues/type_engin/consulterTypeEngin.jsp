...
<div class="card border-0">
    <div class="card-header">
        <h1 class="h3 mt-2 mb-0 fw-semibold">Consultation du type d'engin</h1>
        <span class="text-secondary small mt-1">Consultation des informations du type d'engin.</span>
    </div>
    <div class="card-body p-4">
        ...
        <!-- TypeEngin introuvable -->
        <% } else { %>
        <%
            String alertMessage = "Type d'engin introuvable";
